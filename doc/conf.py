# -*- coding: utf-8 -*-
#
# MRS documentation build configuration file, created by
...
latex_documents = [
  ('index', 'MRS.tex', u'MRS Documentation',
...
texinfo_documents = [
  ('index', 'MRS', u'MRS Documentation',
   u'Ariel Rokem', 'MRS', 'Analysis of MR spectroscopy data.',
   'Miscellaneous'),
]
